...
<!-- 2. Configure the library -->
  <script type="text/javascript">
    ...
    var GAPdataCallback = function(data) {
      ...
      document.getElementById("gapID").innerHTML += "<a href='" + link + "'>" + "<img style='max-height:20em' src='" + image + "'>" + "</a>" + "<br />";
      document.getElementById("gapID").innerHTML += "<a href='" + link + "'>" + itemName + "</a>" + "<br />";
    ...
    var ONdataCallback = function(data) {
      ...
      document.getElementById("onID").innerHTML += "<a href='" + link + "'>" + "<img style='max-height:20em' src='" + image + "'>" + "</a>" + "<br />";
      document.getElementById("onID").innerHTML += "<a href='" + link + "'>" + itemName + "</a>" + "<br />";
    ...
    var searchAT = "<?php echo $_GET['searchVariable'] ?>";
    var ATdataCallback = function(data) {
      ...
      document.getElementById("atID").innerHTML += "<a href='" + link + "'>" + "<img style='max-height:20em' src='" + image + "'>" + "</a>" + "<br />";
      document.getElementById("atID").innerHTML += "<a href='" + link + "'>" + itemName + "</a>" + "<br />";
    ...
    var BRdataCallback = function(data) {
      ...
      document.getElementById("brID").innerHTML += "<a href='" + link + "'>" + "<img style='max-height:20em' src='" + image + "'>" + "</a>" + "<br />";
      document.getElementById("brID").innerHTML += "<a href='" + link + "'>" + itemName + "</a>" + "<br />";
...
// 3. Do the query (when the function is called)
  ...
  <body>
    <script type="text/javascript">var searchVar = "<?php echo $_GET['searchVariable'] ?>";</script>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12 main">
          ...
          <div class="row">
            <div class="col-md-3" id="gapID" style="padding-left:6em">
              <script type="text/javascript">//doQuery(searchVar)</script>
            </div>
            <div class="col-md-3" id="brID" style="padding-left:6em">
              <script type="text/javascript">//doQuery2(searchVar)</script>
            </div>
            <div class="col-md-3" id="atID" style="padding-left:6em">
              <script type="text/javascript">//doQuery3(searchVar)</script>
            </div>
            <div class="col-md-3" id="onID" style="padding-left:6em">
              <script type="text/javascript">//doQuery3(searchVar)</script>
            </div>
          </div>
          </div>
